...
// Light Theme Colors
const appColorRed = Color(0xFFDC3545);
// const appColorRed = Color(0xFFFF033E);
// const appColorBlack = Color(0xFF212529);
const appColorBlack = Color(0xFF262626);
const appColorGrey = Colors.grey;
const appColorWhite = Color(0xFFFFFFFF);
const appShadowColor = Color(0x95E9EBF0);

const boxBackgroundColor = Color(0xFFF8F9FA);
...
const appShadowColorDark = Color(0xEEBBB4C2);
